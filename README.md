...
## v6 additions
- Seller size-chart screenshot extraction.
- More conservative sizing when body measurements are missing.
- Optional user-selected complexion undertone for color coordination.
- Occasion-aware color combinations and practical style tips.
- The photo is used as visual styling context, not as an exact body-measurement source.
